    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    “모든 것이 끝난 후에도, 인간은 여전히 살아있다고 믿는다.”
                    <br />
                    <span style={{ color: "#fff" }}>『애션 미라주』</span>는 인류의 기억 데이터를 기반으로 복원된 세계를 다룬다.
                    <br />
                    <span style={{ color: "#B83232" }}>미라주 시스템</span>은 인간의 감정을 재현했으나,
                    시간이 흐르며 오류와 균열이 발생한다.
                    <br />
                    이곳은 현실의 잔향이 남은 ‘환상 도시(幻城)’,
                    거짓된 낙원이자 진실을 숨긴 거울세계이다.
                </p>
